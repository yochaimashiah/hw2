...
![](hw_titanic_files/figure-markdown_github/unnamed-chunk-18-1.png)
...
```
    ...
    ## glm       0.8322  0.8569 0.8704 0.8695  0.8812 0.9102    0
    ## C5.0      0.8197  0.8557 0.8628 0.8639  0.8765 0.9079    0
    ## xgbLinear 0.8205  0.8434 0.8571 0.8551  0.8646 0.9124    0
    ## 
    ## Sens 
    ##             Min. 1st Qu. Median   Mean 3rd Qu.   Max. NA's
    ## glm       0.8276  0.8600 0.8724 0.8743  0.8915 0.9179    0
    ## C5.0      0.7931  0.8483 0.8693 0.8699  0.8969 0.9261    0
    ## xgbLinear 0.8023  0.8342 0.8622 0.8591  0.8782 0.9179    0
    ## 
    ## Spec 
    ##             Min. 1st Qu. Median   Mean 3rd Qu.   Max. NA's
    ## glm       0.6210  0.7252 0.7500 0.7502  0.7721 0.8261    0
    ## C5.0      0.6639  0.7063 0.7287 0.7342  0.7609 0.8261    0
    ## xgbLinear 0.6452  0.6967 0.7165 0.7270  0.7500 0.8435    0

``` r
dotplot(results)
```

![](hw_titanic_files/figure-markdown_github/unnamed-chunk-29-1.png)
...
```
    ...
    ##                 glm      C5.0 xgbLinear
    ## glm       1.0000000 0.7576976 0.6853132
    ## C5.0      0.7576976 1.0000000 0.8452593
    ## xgbLinear 0.6853132 0.8452593 1.0000000
...
```
    ...
    ## They were weighted: 
    ## -2.8479 3.2904 1.2408 1.0307
    ## The resulting ROC is: 0.8785
    ## The fit for each individual model on the ROC is: 
    ##     method       ROC      ROCSD
    ##        glm 0.8694823 0.01815559
    ##       C5.0 0.8638594 0.01967893
    ##  xgbLinear 0.8550634 0.02000319
...
![](hw_titanic_files/figure-markdown_github/unnamed-chunk-34-1.png)
...
score of svm.model without caret- 0.79904 [a relative link](https://github.com/yochaimashiah/hw2/blob/master/results/submission_svm.csv)
...
score of greedy\_ensemble- 0.77512 [a relative link](https://github.com/yochaimashiah/hw2/blob/master/results/submission_ge.csv)

score of xgb model- 0.79904 [a relative link](https://github.com/yochaimashiah/hw2/blob/master/results/submission_xgb.csv)
