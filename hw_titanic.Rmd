...
```
![Image of github's yak](images/miss.JPG)
...
```
![Image of github's yak](images/p1.JPG)

![Image of github's yak](images/p2.JPG)

![Image of github's yak](images/p3.JPG)
...
```
![Image of github's yak](images/rfmodel.JPG)
...
dotplot(results)
```
![Image of github's yak](images/p4.JPG)
...
[a relative link](results/submission_rf.csv)

score of svm.model- 0.80861
[a relative link](results/submission_svm.csv)

score of greedy_ensemble- 0.77512
[a relative link](results/submission_ge.csv)

score of rf_ensemble- 0.78947
[a relative link](results/submission_rfcs.csv)
